...
public class TextProperty extends ShapeProperty<Ftext> {
    ...
    public static final String NameFontStyle = "font-style";
	...
	public void toFnode(Ftext fnode) {
	    ...
	    String family = getFontFamilyProperty();
	    if(family != null) {
	        Ftext.setFontFamily(fnode.getNode(), family);
	    }
	...
	public boolean updateView(Ftext fnode, PrimeProperty rp) {
		...
		if(rp.getName().equals(NameText)) {
			...
			String text = getFontFamilyProperty();
			if(text != null)
			    Ftext.setFontFamily(fnode.getNode(), text);
			found = true;
		}
